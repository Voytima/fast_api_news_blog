...
from applications.auth_app.routes import user_router
from applications.auth_app.utils import get_current_user
from applications.post_app.routes import post_route
